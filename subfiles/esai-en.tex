...
As an architecture lecture, I propose a number of solutions to anticipate those impact.
First, enhancing the quality of architecture or urban planning education.
This will create architects who are able to address the urban challange.
Secondly, development should adhere to the sustainability concept to promote social, economic, and technological progress with efficient use of natural resources and energy.

Second, development should follow sustainability concept in order to foster social, economic, and technological systems with efficient use of natural resources and energy.



Second, embracing the sustainability approach on construction industry.
The sustainability approach in this sector will develop social, economic, and technological systems with efficient use of natural resources and energy.

Secondly, adopting a sustainability approach in the construction industry. This approach will lead to the development of social, economic, and technological systems with the efficient use of natural resources and energy.


Pendekatan keberlanjutan yang memperhatikan aspek ekonomi, energi, ekologi, partisipasi dan kesamaan akan



This plays a significant role for architecture students as they enter the field. Certainly, it starts from improving the quality of lecturers.

Second, embracing the sustainability approach on planning.
This approach is still


Education becomes a key factor for architecture student in the field to address urban challenges.
This enhancement ought be accompanied by enhancing the quality of their lectures.
